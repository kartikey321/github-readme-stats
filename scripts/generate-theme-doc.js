...
\`\`\`md
![Anurag's GitHub stats](https://github-stats.mahawarkartikey.in/api?username=kartikey321&theme=dark&show_icons=true)
\`\`\`
...
const createRepoMdLink = (theme) => {
  return `\n[${theme}_repo]: https://github-stats.mahawarkartikey.in/api/pin/?username=kartikey321&repo=github-readme-stats&cache_seconds=86400&theme=${theme}`;
};
const createStatMdLink = (theme) => {
  return `\n[${theme}]: https://github-stats.mahawarkartikey.in/api?username=kartikey321&show_icons=true&hide=contribs,prs&cache_seconds=86400&theme=${theme}`;
};
